...
class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    var avatar: UIImageView = {
        let avatar = UIImageView(image: UIImage(named: "988"))
        avatar.toAutoLayout()
    ...
    var setStatusField: UITextField = {
        ...
        setStatusField.placeholder = "Set ..."
        ...
        setStatusField.addTarget(self, action: #selector(statusTextChanged(_:)), for: .editingChanged)
